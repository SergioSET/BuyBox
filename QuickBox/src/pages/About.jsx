  ...
  return (
    <div>
      ...
      <div className="about-content text-center max-w-2xl mx-auto mt-5">
        <h2 className="LovC">¡Descubre mas sobre QuickBox!</h2>
        <p className="TextContUs">
          En QuickBox, nos enorgullecemos de ofrecer una solución innovadora
          ...
          cliente. QuickBox no solo facilita la importación de productos, sino
          ...
          <img
            ...
            className="image-centered border br-2"
          />
          La gestión de órdenes es uno de los pilares fundamentales de QuickBox.
          ...
          calidad superior. En QuickBox, estamos comprometidos con la innovación
