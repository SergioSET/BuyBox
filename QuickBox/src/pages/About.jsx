...
const About = () => {
  return (
    <div>
      <SectionTitle title="Acerca de nosotros" path="Home | About" />
      <div className="about-content text-center max-w-2xl mx-auto mt-5">
      <h2 className="text-6xl text-center mb-10 max-sm:text-3xl text-accent-content">¡Amamos nuestros clientes!</h2>
