...
export default function Features() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center border border-gray-300 hover:border-gray-500 hover:shadow-lg transition-all duration-300 p-4 bg-blue-100 hover:bg-blue-200 rounded-xl w-full sm:w-80 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
  ...
  <p className="text-lg text-gray-400 text-center">Cuenta con una amplia red logística que abarca múltiples ubicaciones internacionales, garantizando la entrega rápida y confiable de tus paquetes desde cualquier parte del mundo.</p>
            ...
            {/* 2nd item */}
            <div className="relative flex flex-col items-center border border-gray-300 hover:border-gray-500 hover:shadow-lg transition-all duration-300 p-4 bg-blue-100 hover:bg-blue-200 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
