            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
                        {/* 1st item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-80 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={logisticsLogo} alt="Logo de la empresa" />
                        ...
                        {/* 2nd item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={passwordLogo} alt="Logo de la empresa" />
                        ...
                        {/* 3rd item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={truckLogo} alt="Logo de la empresa" />
                        ...
                        {/* 4th item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={customerLogo} alt="Logo de la empresa" />
                        ...
                        {/* 5th item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={shoppingLogo} alt="Logo de la empresa" />
                        ...
                        {/* 6th item */}
                        <div className="relative flex flex-col items-center feature-item transition-all duration-300 p-4 rounded-xl w-full sm:w-72 min-h-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                            <img className="w-16 h-16 mb-4" src={payLogo} alt="Logo de la empresa" />
